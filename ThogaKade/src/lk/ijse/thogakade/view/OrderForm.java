...
public class OrderForm extends javax.swing.JFrame {
    ...
    private void btnPlaceOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPlaceOrderActionPerformed
        ...
        DefaultTableModel dtm=(DefaultTableModel) tblItemDetails.getModel();
        for (int i = 0; i < dtm.getRowCount(); i++) {
            String itemCode=(String) tblItemDetails.getValueAt(i, 0);
            int orderQty=(int) tblItemDetails.getValueAt(i, 2);
            double unitPrice=(double) tblItemDetails.getValueAt(i, 3);
